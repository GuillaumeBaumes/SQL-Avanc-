...
CREATE TABLE `player` (
  ...
  CONSTRAINT `fk_player_team` FOREIGN KEY (`team_id`) REFERENCES `team` (`team`),
  CONSTRAINT `fk_player_wizard` FOREIGN KEY (`wizard_id`) REFERENCES `wizard` (`wizard`)
...
-- Dump completed on 2021-09-26 17:05:25
